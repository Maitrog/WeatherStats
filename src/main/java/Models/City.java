...
public class City {
    ...
    public City(int id, String nameRu, String nameEn, String urlYandex, String urlRambler, String urlWorldWeather, String country, List<Weather> _weathers) {
        this.id = id;
        this.nameRu = nameRu;
        this.nameEn = nameEn;
    ...
    public void addWeather(List<Weather> _weathers) {
